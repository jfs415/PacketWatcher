...
public class CountryStatsController {
	...
	public ResponseEntity<StatsCollectionView> getCountryStatsWithRecordsCaughtGreaterThan(@RequestParam int greaterThan) {
	...
	public ResponseEntity<StatsCollectionView> getCountryStatsWithRecordsCaughtBetweenThan(@RequestParam int start, @RequestParam int end) {
	...
	public ResponseEntity<StatsCollectionView> getCountryStatsWithFirstCaughtBetween(@RequestParam long start, @RequestParam long stop) {
	...
	public ResponseEntity<StatsCollectionView> getCountryStatsWithLastCaughtBetween(@RequestParam long start, @RequestParam long stop) {
