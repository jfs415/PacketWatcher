...
public class InvalidEventArgumentException extends InvalidArgumentException {
    ...
    private static final String DEFAULT_MESSAGE = "Only " + AuthorizationDeniedEvent.class.getSimpleName() 
            + " and " + AuthorizationGrantedEvent.class.getSimpleName() + " are accepted!";
