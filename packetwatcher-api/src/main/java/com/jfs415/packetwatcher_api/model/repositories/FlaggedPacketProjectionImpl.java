...
public class FlaggedPacketProjectionImpl implements FlaggedPacketProjectionRepository {
    ...
    public List<FlaggedPacketRecordProjection> getTopByHostname(int limit) {
        ...
        Expression<Integer> count = queryParams.builder().count(queryParams.root()).as(Integer.class);
        queryParams
                .query()
                .select(queryParams
                        .builder()
                        .construct(FlaggedPacketRecordProjection.class, queryParams.root().get(DESTINATION_HOST), count));

        queryParams.query().where(queryParams.root().get(DESTINATION_HOST).isNotNull(),
        ...
        return entityManager.createQuery(queryParams.query()).setMaxResults(limit).setMaxResults(limit).getResultList();
    }
    ...
    public List<FlaggedPacketRecordProjection> getTopByCountry(int limit) {
        ...
        queryParams
                ...
                .select(queryParams
                        .builder()
                        .construct(FlaggedPacketRecordProjection.class, queryParams.root().get(FLAGGED_COUNTRY), count));
        ...
        return entityManager.createQuery(queryParams.query()).setMaxResults(limit).getResultList();
    }
    ...
    public List<FlaggedPacketRecordProjection> getTopByTimeOfDay(int limit) {
        ...
        queryParams
                ...
                .select(queryParams
                        .builder()
                        .construct(FlaggedPacketRecordProjection.class, function, count));
    ...
    public List<FlaggedPacketTimelineProjection> getTimelineData(long startMillis, long endMillis) {
        ...
        CriteriaQuery<FlaggedPacketTimelineProjection> query = builder.createQuery(FlaggedPacketTimelineProjection.class);
        ...
        Expression<?> function = builder.function("DATE", Timestamp.class, root.get(KEY).get(TIMESTAMP)).as(String.class);
    ...
    private Expression<?> createFunctionTimestampGroupBy(QueryParameters queryParams, String functionName) {
        return queryParams
                .builder()
                .function(functionName, Timestamp.class, queryParams.root().get(KEY).get(TIMESTAMP)).as(String.class);
    }
